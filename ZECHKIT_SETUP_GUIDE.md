...
```bash
# Replace 'zeckit-demo' with your project name
mkdir zeckit-demo && cd zeckit-demo
git init
echo "# ZecKit Demo" > README.md
git add README.md
...
Use the ZecKit CLI to generate the standardized GitHub Action configuration.
```bash
# Run the ZecKit Generator
/mnt/data/Projects/Zeck/ZecKit/cli/target/debug/zeckit init --backend zaino
```
